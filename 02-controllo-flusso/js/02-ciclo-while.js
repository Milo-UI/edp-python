/*
    ...
    Infatti il while tra parentesi richiede solo la condizione, ma questo porta qualche problema, per esempio se diciamo che la condisione deve essere (i < 5), otteniamo un errore, dal momento che la variabile i non è mai stata dichiarata.
